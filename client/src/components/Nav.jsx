          ...
          <div className=" flex-1 relative w-full ">
            ...
            <div className={`relative 1`} >
              ...
              <input
                ...
                className={`block w-full outline-none p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-fgray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
                  ${theme == "dark" ? "bg-slate-600 text-white" : "" }
                `} placeholder="Search with username " required value={value} />
            ...
            <div className={`search-results absolute w-full mt-5 z-10  shadow-lg py-4 rounded-md bg-white ${value.length < 2 ? "hidden" : "" }   ${hasFocus ? "" : "hidden"}  `}>
